...
This project is indexed by GitNexus as **pact-network** (1248 symbols, 2507 relationships, 84 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
