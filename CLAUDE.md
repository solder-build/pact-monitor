...
This project is indexed by GitNexus as **pact-network** (1183 symbols, 2380 relationships, 71 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
