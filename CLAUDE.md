...
This project is indexed by GitNexus as **pact-network** (1465 symbols, 2970 relationships, 103 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
