...
This project is indexed by GitNexus as **pact-network** (996 symbols, 1964 relationships, 61 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
