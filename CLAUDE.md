...
This project is indexed by GitNexus as **pact-network** (1300 symbols, 2598 relationships, 87 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
