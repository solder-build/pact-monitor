...
This project is indexed by GitNexus as **pact-network** (1536 symbols, 3143 relationships, 112 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
