...
packages/
  ...
  insurance/  — @q3labs/pact-insurance: TypeScript SDK for the on-chain Anchor insurance program
...
This project is indexed by GitNexus as **pact-network** (882 symbols, 1717 relationships, 40 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
