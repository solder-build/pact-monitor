...
This project is indexed by GitNexus as **pact-network** (862 symbols, 1660 relationships, 37 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
