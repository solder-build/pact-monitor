...
This project is indexed by GitNexus as **pact-network** (883 symbols, 1717 relationships, 40 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
