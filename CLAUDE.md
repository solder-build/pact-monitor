...
This project is indexed by GitNexus as **pact-network** (873 symbols, 1693 relationships, 41 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
