...
This project is indexed by GitNexus as **pact-network** (1148 symbols, 2262 relationships, 72 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
