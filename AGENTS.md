...
This project is indexed by GitNexus as **pact-network** (861 symbols, 1655 relationships, 36 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
