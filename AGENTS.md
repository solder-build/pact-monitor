...
This project is indexed by GitNexus as **pact-network** (1278 symbols, 2569 relationships, 86 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
