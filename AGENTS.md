...
This project is indexed by GitNexus as **pact-network** (874 symbols, 1694 relationships, 41 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
